...
- [Build Command](/reference/cli/build) - Production builds
- [Usage Patterns](/reference/cli/usage-patterns) - Development workflows
- [Troubleshooting](/reference/cli/troubleshooting) - Server issues
