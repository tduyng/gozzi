...
- [Serve Command](/reference/cli/serve) - Server command details
- [Usage Patterns](/reference/cli/usage-patterns) - Best practices
- [Configuration Guide](/guide/configuration/) - Config troubleshooting
